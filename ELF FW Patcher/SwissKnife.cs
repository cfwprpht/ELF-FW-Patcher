...
namespace SwissKnife {
        ...
        public static T[] RemoveEmpty<T>(this T[] source) {
            ...
            foreach (T entry in source) {
                if (typeof(T).IsValueType) {
                    ...
                    else MessageBox.Show("[ArrayExtension]\n[Function]:\nRemoveEmpty<T>(this T[] source);\nSorry this format is currently not Supported.\n" + typeof(T).ToString());
                } else if (default(T) == null) { if (entry.Equals(null)) toRemove.Add(source.IndexOf(entry)); } else MessageBox.Show("[ArrayExtension]\n[Function]:\nRemoveEmpty<T>(this T[] source);\nSorry this format is currently not Supported.\n" + typeof(T).ToString());
            }
    ...
    */
    ...
    static class StringExtension {
        ...
        /// <summary>
        /// Reverse a Hexstring Endian wise.
        /// </summary>
        ...
        public static string[] ReadAllLines(this string source) {
            ...
            } catch (IOException io) { MessageBox.Show(io.ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
    ...
    static class ByteExtension {
        ...
        /// <returns>The Converted Hex String as bytes.</returns>
